...
Báo cáo định kỳ thực tập tốt nghiệp đại học (Lần 2) được bố cục chặt chẽ thành 3 chương nội dung chính, thể hiện tiến trình từ khảo sát bài toán, xây dựng nền tảng lý thuyết đến phân tích yêu cầu và thiết kế hệ thống tổng thể:
...
- *Chương 3: Phân tích yêu cầu và thiết kế hệ thống:* Trình bày chi tiết phân tích các tác nhân (User, Moderator, Super Admin) và Sơ đồ ngữ cảnh hệ thống (System Context Diagram); danh mục 17 ca sử dụng kèm đặc tả đầy đủ cho 10 ca sử dụng trọng yếu và bộ 25 Quy tắc nghiệp vụ (Business Rules) ràng buộc sự vận hành của nền tảng; mô hình hóa quy trình bằng sơ đồ hoạt động, sơ đồ trạng thái và sơ đồ trình tự; bộ 51 Yêu cầu chức năng và 29 Yêu cầu phi chức năng định lượng kèm ma trận CRUD và ma trận truy xuất nguồn gốc; sau cùng là thiết kế kiến trúc tổng thể, các bản ghi quyết định kiến trúc (ADRs), mô hình dữ liệu ý niệm và thiết kế cơ sở dữ liệu vật lý.
