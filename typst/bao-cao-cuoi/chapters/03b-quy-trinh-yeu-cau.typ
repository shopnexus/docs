...
#figure(
  ...
  table(
    ...
    [REQ-06], [cho phép người dùng sửa thông tin hiển thị, quản lý sổ địa chỉ với một mặc định cho mỗi loại.], [UC-04], [tài khoản], [BR-57],
    ...
    [REQ-36], [cho phép điều phối viên ra phán quyết với đúng 2 kết cục cho một hồ sơ đang chờ phân xử, và đóng mọi phiếu hỗ trợ đang mở nhắm vào hồ sơ đó.], [UC-26], [đơn hàng, tín nhiệm], [BR-41, BR-43, BR-50],
    [REQ-37], [tiếp nhận mọi loại yêu cầu người dùng gửi lên dưới dạng một phiếu hỗ trợ có hội thoại riêng với bàn hỗ trợ, và ẩn danh tính người trả lời.], [UC-23, UC-24], [tín nhiệm, trò chuyện], [BR-03, BR-44, BR-45, BR-46, BR-47, BR-48],
    ...
    [REQ-49], [cho phép quản trị viên ghi một bút toán điều chỉnh số dư bằng tay kèm lý do bắt buộc, cùng đường ghi sổ như mọi biến động khác.], [UC-29], [tài chính], [BR-35, BR-55],
