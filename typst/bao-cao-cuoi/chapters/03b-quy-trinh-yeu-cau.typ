...
Đơn hàng gồm bốn trạng thái, được suy ra trực tiếp từ các mốc thời gian phản ánh kết quả xử lý thay vì lưu trong một trường trạng thái riêng. Cách tiếp cận này giúp tránh sai lệch giữa trạng thái và dữ liệu thực tế. Sơ đồ dưới đây thể hiện các chuyển đổi trạng thái hợp lệ mà tầng nghiệp vụ phải tuân thủ; mọi chuyển đổi ngoài phạm vi này đều bị từ chối.

Việc suy ra trạng thái được thực hiện theo thứ tự ưu tiên cố định: đã huỷ, đã hoàn tất, đã được người bán xác nhận, và cuối cùng là đang mở. Thứ tự này là một phần của đặc tả nghiệp vụ, nhằm bảo đảm kết quả nhất quán trong các tình huống cạnh tranh. Chẳng hạn, nếu đơn hàng đồng thời có mốc xác nhận và mốc huỷ, hệ thống luôn xác định trạng thái là đã huỷ.
...
#figure(
  ...
  table(
    ...
    [REQ-22], [cho người mua thêm, sửa số lượng và bỏ bớt các dòng hàng trong giỏ; giỏ chỉ giữ tham chiếu tới tin đăng và tuỳ chọn, không giữ giá.], [UC-13], [đơn hàng], [],
    [REQ-23], [lập một phiếu mua tạm đóng băng giá niêm yết trong 30 phút từ các mục người mua đã chọn.], [UC-14], [đơn hàng], [BR-54],
    [REQ-24], [hỏi giá vận chuyển từ mọi hãng đang bật cho một phiếu mua tạm hoặc một thương lượng đã chấp thuận, và loại hãng nào không báo giá được.], [UC-14], [đơn hàng], [BR-25, BR-52],
    [REQ-25], [giành quyền dùng phiếu mua tạm hoặc thương lượng đã chấp thuận trước khi mở phiên thanh toán 15 phút, và trả lại quyền đó khi phiên hết hạn.], [UC-15], [đơn hàng, tài chính], [BR-23, BR-24],
    [REQ-26], [chỉ ghi nhận kết quả thanh toán từ thông báo gọi lại của nhà cung cấp, và không phát sinh bút toán mới khi cùng một thông báo được gửi lại.], [UC-15], [tài chính], [BR-22],
    [REQ-27], [giữ tiền hàng vào ký quỹ, tách phí giao hàng thành chặng riêng, rồi tạo đơn hàng và kiện hàng ở trạng thái chờ người bán xác nhận.], [UC-15, UC-16], [tài chính, đơn hàng], [BR-21, BR-26],

    table.cell(colspan: 5, align: left)[*Nhóm 7. Vòng đời đơn hàng và giải ngân*],
    [REQ-28], [cho phép người bán xác nhận đơn trong 48 giờ, và chỉ đặt vận đơn với hãng sau khi đơn đã được xác nhận.], [UC-16], [đơn hàng], [BR-28, BR-30],
    [REQ-29], [cho phép người bán từ chối đơn kèm lý do bắt buộc, hoàn cho người mua cả tiền hàng lẫn phí giao hàng, và trả lại tồn kho.], [UC-16], [đơn hàng, tài chính, danh mục], [BR-27, BR-29],
    [REQ-30], [cảnh báo bộ phận vận hành khi hết 48 giờ mà đơn chưa được xác nhận, và giữ nguyên trạng thái của đơn.], [UC-16], [đơn hàng, tín nhiệm], [BR-28],
    [REQ-31], [cập nhật mốc hành trình của kiện hàng theo thông báo của hãng, bỏ qua mốc lùi và mốc không thuộc từ vựng hệ thống.], [UC-17], [đơn hàng], [BR-31],
    [REQ-32], [bắt buộc người mua đính kèm ít nhất một tệp bằng chứng khi xác nhận đã nhận hàng.], [UC-18], [đơn hàng], [BR-33],
    [REQ-33], [chuyển tiền hàng từ ký quỹ sang số dư khả dụng của người bán sau 72 giờ kể từ khi người mua xác nhận, nếu không có hồ sơ hoàn tiền đang sống.], [UC-18], [đơn hàng, tài chính], [BR-32, BR-34],

    table.cell(colspan: 5, align: left)[*Nhóm 8. Trả hàng, hoàn tiền và phiếu hỗ trợ*],
    [REQ-34], [cho phép người mua mở hồ sơ hoàn tiền kèm lý do và bằng chứng trước khi đơn kết thúc, và loại đơn đó khỏi danh sách chờ giải ngân.], [UC-20], [đơn hàng], [BR-37],
    [REQ-35], [giới hạn nước đi của người bán trong 48 giờ ở hai lựa chọn là chấp nhận cho trả hàng hoặc chuyển hồ sơ cho sàn, và tự chuyển khi hết hạn.], [UC-21], [đơn hàng], [BR-39, BR-40],
    [REQ-36], [mở chặng trả hàng với phí bằng không khi hồ sơ được chấp nhận, mở 48 giờ kiểm hàng khi người bán xác nhận đã nhận hàng, và hoàn tiền khi hết cửa sổ đó.], [UC-21], [đơn hàng, tài chính], [BR-38, BR-42],
    [REQ-37], [cho phép điều phối viên ra phán quyết với đúng 2 kết cục cho một hồ sơ đang chờ phân xử, và đóng mọi phiếu hỗ trợ đang mở nhắm vào hồ sơ đó.], [UC-26], [đơn hàng, tín nhiệm], [BR-41, BR-43, BR-50],
    [REQ-38], [tiếp nhận mọi loại yêu cầu người dùng gửi lên dưới dạng một phiếu hỗ trợ có hội thoại riêng với bàn hỗ trợ, và ẩn danh tính người trả lời.], [UC-23, UC-24], [tín nhiệm, trò chuyện], [BR-03, BR-44, BR-45, BR-46, BR-47, BR-48],
    [REQ-48], [cho phép người mua rút hồ sơ hoàn tiền khi người bán chưa trả lời, đưa hồ sơ về một trạng thái kết thúc riêng khác với bị bác bỏ, và trả đơn về danh sách chờ giải ngân.], [UC-20], [đơn hàng], [BR-37],

    table.cell(colspan: 5, align: left)[*Nhóm 9. Đánh giá, uy tín và ví*],
    [REQ-39], [cho phép người đã mua viết nhận xét sản phẩm, người bán phản hồi và người dùng bình chọn hữu ích, đếm tách rời với đánh giá giao dịch.], [UC-22], [tín nhiệm, danh mục], [BR-52, BR-51],
    [REQ-40], [hiển thị số dư khả dụng, số dư đang giữ và sổ bút toán chỉ-thêm-mới của ví.], [UC-19], [tài chính], [BR-35],
    [REQ-41], [cho phép rút phần số dư khả dụng về tài khoản ngân hàng đã đăng ký, trừ ví ngay khi yêu cầu được tạo và hoàn lại khi bị từ chối.], [UC-19, UC-29], [tài chính], [BR-07, BR-36],
    [REQ-49], [cho phép quản trị viên ghi một bút toán điều chỉnh số dư bằng tay kèm lý do bắt buộc, cùng đường ghi sổ như mọi biến động khác.], [UC-29], [tài chính], [BR-35, BR-53],
    ...
    [REQ-43], [cho phép quản trị viên bật, tắt hoặc đổi nhà cung cấp phục vụ cho từng dòng của sổ tuỳ chọn, và giữ dòng đã tắt ở dạng đọc được cho bản ghi cũ.], [UC-28], [tài chính, đơn hàng], [BR-52],
    ...
    [REQ-45], [ghi một bản ghi kiểm toán chỉ-thêm-mới trong cùng giao dịch cơ sở dữ liệu với mỗi quyết định nghiệp vụ và mỗi biến động tiền.], [UC-S2], [tất cả], [BR-53],
