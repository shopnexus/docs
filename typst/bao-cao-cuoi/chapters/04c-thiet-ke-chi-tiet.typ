...
#fig-xoay(
  ...
  cls((2, 1), "OAuthIdentity", name: <a-oa>, attrs: ("- provider, providerUID", "  MỘT tài khoản một nhà cung cấp")),
...
#fig-xoay(
  ...
  cls((1, 2), "Tag", name: <c-tag>, attrs: ("- slug: string  khoá chính", "- description: *string")),
...
#fig-xoay(
  ...
  msg(
    ...
    4,
    5.8,
    [9b. Mở luồng hội thoại cho phiếu theo kiểu cố-gắng-hết-\ sức, thiếu thì sửa lại khi có người mở phiếu],
  ),

  msg(5, 1, 7.2, [10. Nhân viên vận hành phán quyết:\ người mua thắng hoặc người bán thắng]),
  step(1, 8.7, [
    11. Người mua thắng mà đã trả hàng thì kết toán ngay;\ thắng mà chưa trả thì chuyển sang đang
