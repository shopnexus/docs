...
- *Sự phân mảnh trong giao tiếp và thỏa thuận giao dịch:* Đặc thù của mua bán đồ cũ là nhu cầu thương lượng giá (mặc cả) và kiểm chứng thực tế bằng hình ảnh/video trực tiếp. Hiện nay, quy trình này thường diễn ra phân mảnh trên các ứng dụng nhắn tin bên thứ ba ngoài sàn (như Zalo, Messenger, Telegram). Khi hai bên thống nhất một mức giá ưu đãi (ví dụ: bớt 50.000 đồng vì hỗ trợ phí vận chuyển), việc thanh toán trên sàn giao dịch lại không đồng bộ được mức giá thỏa thuận này một cách tự động. Đồng thời, khi tranh chấp xảy ra, các sàn thương mại điện tử (TMĐT) truyền thống không có quyền truy cập hoặc không thể xác thực tính chính xác của các đoạn chat bên ngoài, dẫn đến thiếu chứng cứ lịch sử gắn liền với đơn hàng để phân xử công bằng.
