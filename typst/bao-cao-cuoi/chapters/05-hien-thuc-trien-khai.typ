...
+ *Tích hợp bên thứ ba:* 6 seam có máy khách của nhà cung cấp thật đều mới chỉ dừng ở mức đã viết xong và kiểm thử bằng máy chủ HTTP giả dựng ngay trong ca kiểm thử; chưa có lời gọi nào chạm tới môi trường Sandbox hay Production của đối tác, nên cũng chưa có đối soát giao dịch thật. 2 seam còn lại thì chưa có cả bản hiện thực của một nhà cung cấp thật: vận chuyển mới chỉ có bản giả lập, lưu trữ tệp mới chỉ ghi xuống hệ tệp cục bộ.
