...
#figure(
  ...
  table(
    ...
    [UC-18], [Quản lý ví và rút tiền], [Người dùng], [Theo dõi số dư khả dụng và đang giữ, xem sổ bút toán, gửi yêu cầu rút về tài khoản ngân hàng.],
    ...
    [UC-22], [Gửi phiếu hỗ trợ], [Người dùng], [Gửi mọi loại yêu cầu lên sàn: tố cáo, khiếu nại hoàn tiền, sự cố đơn, vướng mắc thanh toán, đề xuất.],
